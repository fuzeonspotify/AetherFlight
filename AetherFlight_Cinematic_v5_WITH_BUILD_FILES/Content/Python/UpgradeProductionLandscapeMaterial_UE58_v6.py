"""Build Aether Flight's seven-biome production Landscape material.

This material-only pass preserves the existing 4033 Landscape, Layer Info
assets and imported biome weightmaps. It reduces obvious
...
def log(message: str) -> None:
    unreal.log(f"[Aether UE5.8 Production Material v6] {message}")
...
def main() -> None:
    ...
    unreal.EditorDialog.show_message(
        "Aether UE5.8 Production Landscape Material v6",
        "The seven-biome Landscape material was built successfully.\n\n"
        "Grass, forest floor, rock, scree, snow, sand, and wetland now use soft normalized masks.\n"
